<?php
    ...
    try
    {
        ...
        $Page->SetShortCaption($Page->GetLocalizerCaptions()->GetMessageString('Stock_Expiry'));
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption($Page->GetLocalizerCaptions()->GetMessageString('Stock_Expiry'));
