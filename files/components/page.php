...
abstract class Page implements IPage, IVariableContainer
{
    ...
    public $AdvancedSearchControl; // TODO : wrap with methods
    ...
    public $Margin; // TODO : wrap with method
    public $Padding; // TODO : wrap with method
    #endregion
    ...
    public function FillVariablesValues(array &$values)
    {
        $values = array();
    ...
    public function FillAvailableVariables(array &$variables)
    {
    ...
    {
        if (!isset($columnVariableContainer))
