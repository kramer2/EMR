...
abstract class Renderer
{
    ...
    public function RenderDef($object, $default = '', array $additionalParams = null)
    {
        if (isset($object))
    ...
    private function RenderEditor(CustomEditor $editor, $nameInTemplate, $templateFile, array $additionalParams = array())
    {
