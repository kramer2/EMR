...
$.fn.sm_show_grid_error = function (a_options) {
    ...
    function RemoveErrorPanelHandler() {
...
$.fn.sm_inline_grid_edit = function (a_options) {
    ...
    function SetupEditControls(editControlsContainer) {
        ...
        initEditControl.click(ShowInlineEditors);
    ...
    function CancelEditingClickHandler() {
    ...
    function CommitClickHandler() {
        ...
        CommitInlineEditing_IFrame(row, editControlsContainer);
    }
    ...
    function EmbedEditorFromXml(row, editorXmlElement) {
        ...
        inlineEditorContainer.append(editorHtml);
    ...
    function MoveRowInlineEditorsToForm(row, targetForm) {
        targetForm.append(row.find('td[data-inline-editing=true] div.inline_editor_container'));
    }
    ...
    function CommitInlineEditing_IFrame(row, editControlsContainer) {
        var currentRow = row;
    ...
    function CancelInsertHandler() {
        var row = $(this).closest('tr');
        row.next().remove();
        row.remove();
    }

    function CommitInsertHandler() {
        var row = $(this).closest('tr');
