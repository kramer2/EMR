...
"
                onchange="if (document.getElementById('<?php echo $this->_tpl_vars['Column']->GetFiterTypeInputName(); ?>
...
_second').style.display = 'none';     if (document.getElementById('<?php echo $this->_tpl_vars['Column']->GetFiterTypeInputName(); ?>
').value == 'IS NULL') document.getElementById('<?php echo $this->_tpl_vars['Column']->GetFieldName(); ?>
_value').style.display = 'none'; else document.getElementById('<?php echo $this->_tpl_vars['Column']->GetFieldName(); ?>
_value').style.display = '';">
...
if ($this->_foreach['ColumnsIterator']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['Column']):
        $this->_foreach['ColumnsIterator']['iteration']++;
?>
    if (document.getElementById('<?php echo $this->_tpl_vars['Column']->GetFiterTypeInputName(); ?>
').value == 'between')
...
$(function()
{
	$('#advsearch_submit').click(function()
	{
		...
		$('table.adv_filter').find('td.adv_filter_editor1_cell').find('input').each(function()
		{
