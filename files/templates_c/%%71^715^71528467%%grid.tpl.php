...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'list/grid.tpl', 46, false),)), $this); ?>
...
<table id="<?php echo $this->_tpl_vars['Grid']->GetName(); ?>
" class="grid"<?php if (! $this->_tpl_vars['Grid']->UseAutoWidth()): ?> style="width: <?php echo $this->_tpl_vars['Grid']->GetWidth(); ?>
"<?php endif; ?>>
...
?>
        <?php if ($this->_tpl_vars['Band']->GetUseConsolidatedHeader()): ?>
            <?php if ($this->_tpl_vars['Band']->HasColumns()): ?>
                <th colspan="<?php echo $this->_tpl_vars['Band']->GetColumnCount(); ?>
" <?php if (! ($this->_foreach['BandsHeader']['iteration'] == $this->_foreach['BandsHeader']['total'])): ?>style="<?php if ($this->_tpl_vars['Page']->GetPageDirection() == 'rtl'): ?>border-left<?php else: ?>border-right<?php endif; ?>: solid 2px #000000;"<?php endif; ?> class="<?php if (!(1 & ($this->_foreach['BandsHeader']['iteration']-1))): ?>even<?php else: ?>odd<?php endif; ?>">
